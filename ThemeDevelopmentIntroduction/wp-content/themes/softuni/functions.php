...
function softuni_assets($hook) {
	...
	wp_enqueue_script( 'booltstrap-mini-js', get_template_directory_uri() . 'assets/js/bootstrap.min.js',  array(), '1.0.0', $args);
	wp_enqueue_script( 'jquery.magnific-popup.min.js', get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js',  array(), '1.0.0', $args);
	wp_enqueue_script( 'booltstrap-mini', get_template_directory_uri() . '/assets/js/owl.carousel.min.js',  array(), '1.0.0', $args);
